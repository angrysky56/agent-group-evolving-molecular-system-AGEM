...
export interface Artifact {
    id: string;
    type: "report" | "analysis" | "graph_snapshot" | "agent_summary" | "code" | "markdown";
    title: string;
    content: string;
    path?: string;
}
...
export type SSEEventType = "token" | "thinking" | "artifact" | "agem_state" | "error" | "done" | "usage";
/** System event types streamed via /system/events SSE endpoint. */
export type SystemEventType = "soc:metrics" | "phase:transition" | "regime:classification" | "sheaf:consensus-reached" | "sheaf:h1-obstruction-detected" | "lumpability:audit-complete" | "lumpability:weak-compression" | "soc:system1-early-convergence" | "orch:vdw-agent-spawned" | "orch:vdw-agent-complete" | "tna:catalyst-questions-generated" | "evolution:price-decomposition" | "agem:state-update";
