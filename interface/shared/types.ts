...
export type ReasoningArtifactStatus =
  | "observation"
  | "discovery-candidate"
  | "typed-claim"
  | "verified-finding"
  | "repair-candidate"
  | "counterfactually-validated-repair"
  | "accepted-patch";
...
export type CohomologySnapshot =
...
export interface CatalystQuestionResult {
  ...
  context_refs: Array<{ entry_id: string; similarity: number }>;
  proposed_edge: {
    source: string;
    target: string;
