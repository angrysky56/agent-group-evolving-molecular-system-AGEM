 ...
 */
export declare class GptTokenCounter implements ITokenCounter {
    countTokens(text: string): number;
}
/**
 ...
 */
export declare class MockEmbedder implements IEmbedder {
    embed(text: string): Promise<Float64Array>;
}
/**
 ...
 */
export declare class MockCompressor implements ICompressor {
    compress(text: string, targetRatio: number): Promise<string>;
}
