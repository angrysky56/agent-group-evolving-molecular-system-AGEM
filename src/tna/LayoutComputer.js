...
const forceAtlas2 = _require("graphology-layout-forceatlas2");
// ---------------------------------------------------------------------------
...
export class LayoutComputer extends EventEmitter {
    ...
    #hasComputedInitial = false;
    constructor(cooccurrenceGraph, layoutConfig, computerConfig) {
        super();
    ...
    computeIfDue(iteration) {
        ...
        const physicsIter = this.#hasComputedInitial
            ? Math.max(1, Math.round(this.#layoutConfig.iterations *
...
//# sourceMappingURL=LayoutComputer.js.map