 ...
 */
export async function computeEntropyProfile(texts, embedder, tokenCounter) {
    if (texts.length === 0) {
        return {
            entropy: 0,
 ...
 */
export function computeCentroidSimilarity(source, summary) {
    return cosineSimilarity(source.centroid, summary.centroid);
}
//# sourceMappingURL=entropyProfile.js.map