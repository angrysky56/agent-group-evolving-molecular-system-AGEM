...
export class MCPBridge {
   ...
   */
  async onAuditComplete(result: AuditResult): Promise<void> {
    if (!this.#client.isConnected("sheaf-consistency-enforcer")) return;
   ...
   */
  async onWeakCompression(result: AuditResult): Promise<void> {
   ...
   */
  async checkClosureStatus(): Promise<unknown> {
    if (!this.#client.isConnected("sheaf-consistency-enforcer")) return null;
