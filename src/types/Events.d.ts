 ...
 */
export type SheafEventType = "sheaf:consensus-reached" | "sheaf:h1-obstruction-detected" | "sheaf:iteration-complete";
/**
 ...
 */
export type SOCEventType = "soc:metrics" | "phase:transition" | "phase:transition-confirmed" | "regime:classification" | "soc:system1-early-convergence";
/**
 ...
 * Use exhaustive switch/match patterns against the `type` field.
 */
export type SOCEvent = SOCMetricsEvent | SOCPhaseTransitionEvent | PhaseTransitionConfirmedEvent | RegimeClassificationEvent | System1EarlyConvergenceEvent;
/**
 ...
 */
export type OrchestratorEventType = "orch:vdw-agent-spawned" | "orch:vdw-agent-complete";
/**
 ...
 */
export type TNAEventType = "tna:catalyst-questions-generated" | "tna:centrality-change-detected" | "tna:topology-reorganized" | "tna:layout-updated";
/**
 ...
 */
export type TNAEvent = CatalystQuestionsGeneratedEvent | CentralityChangeDetectedEvent | TopologyReorganizedEvent | LayoutUpdatedEvent;
/**
 ...
 */
export type LumpabilityEventType = "lumpability:audit-complete" | "lumpability:weak-compression";
/**
 ...
 */
export type LumpabilityEvent = LumpabilityAuditCompleteEvent | LumpabilityWeakCompressionEvent;
/**
 ...
 */
export type EvolutionEventType = "evolution:price-decomposition" | "evolution:reinforcement-applied";
/**
 ...
 */
export type EvolutionEvent = PriceDecompositionEvent | ReinforcementAppliedEvent;
