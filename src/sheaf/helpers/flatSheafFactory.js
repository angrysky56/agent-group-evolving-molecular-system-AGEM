 ...
 */
function buildFlatEdge(srcIdx, tgtIdx, stalkDim) {
 ...
 */
export function buildFlatSheaf(numVertices, stalkDim, topology = "path") {
    if (numVertices < 1) {
    ...
    switch (topology) {
        ...
        case "triangle": {
            if (numVertices !== 3) {
                throw new Error(`buildFlatSheaf: 'triangle' topology requires numVertices = 3, got ${numVertices}`);
            }
...
//# sourceMappingURL=flatSheafFactory.js.map